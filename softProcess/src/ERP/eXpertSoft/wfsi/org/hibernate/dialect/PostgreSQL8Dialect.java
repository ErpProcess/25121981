package ERP.eXpertSoft.wfsi.org.hibernate.dialect;
...
public class PostgreSQL8Dialect extends Dialect {
	...
	public boolean supportsOuterJoinForUpdate() {
		...
		// PostgreSQL 8.1 supports LOCK ... NO WAIT, just not FOR UPDATE NOWAIT
		// Leave NOWAIT support at the default for 8.0 and 8.1
