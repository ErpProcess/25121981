...
public class WebRootFolderBean extends GenericBean  implements Serializable {

	public WebRootFolderBean() {
		super();
	}

@EmbeddedId private IdWebRootFolderBean pk_web_root = new IdWebRootFolderBean();
	...
	@Transient  private String cheminProject = "";
	@Transient  private String sousmod_action = "";
	
	
	
	
	@Transient  private String to_check_form = "";
	@Transient  private String to_check_filter = "";
	@Transient  private String to_check_list = "";

    @Transient  private String chaineColumn = "";

    
	@Transient  private List<WebRootFolderBean> listAttributeEntite= new ArrayList<WebRootFolderBean>();
    @Transient  private List <WebRootFolderBean>listform=new ArrayList<WebRootFolderBean>();
    @Transient  private List <WebRootFolderBean>listfilter=new ArrayList<WebRootFolderBean>();
    @Transient  private List <WebRootFolderBean>listgrid=new ArrayList<WebRootFolderBean>();
	...
	public IdWebRootFolderBean getPk_web_root() {
		return pk_web_root;
	}

	public void setPk_web_root(IdWebRootFolderBean pk_web_root) {
		this.pk_web_root = pk_web_root;
	}

	public String getCheminProject() {
		return cheminProject;
	}

	public void setCheminProject(String cheminProject) {
		this.cheminProject = cheminProject;
	}
	...
	public String getTo_check_form() {
		return to_check_form;
	}

	public void setTo_check_form(String to_check_form) {
		this.to_check_form = to_check_form;
	}

	public String getTo_check_filter() {
		return to_check_filter;
	}

	public void setTo_check_filter(String to_check_filter) {
		this.to_check_filter = to_check_filter;
	}

	public String getTo_check_list() {
		return to_check_list;
	}

	public void setTo_check_list(String to_check_list) {
		this.to_check_list = to_check_list;
	}

	public List getListAttributeEntite() {
		return listAttributeEntite;
	}
	...
	public void setListAttributeEntite(List<WebRootFolderBean> listAttributeEntite) {
		this.listAttributeEntite = listAttributeEntite;
	}

	public void setListform(List<WebRootFolderBean> listform) {
		this.listform = listform;
	}

	public void setListfilter(List<WebRootFolderBean> listfilter) {
		this.listfilter = listfilter;
	}

	public void setListgrid(List<WebRootFolderBean> listgrid) {
