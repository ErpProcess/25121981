...
@JsonAutoDetect
@Entity
@Table(name = "article_lieux", schema = DBSchemaTable.SCHEMA_GESTIONCOMMERCIALE)
public class LieuxArticleBean extends GenericBean {

	private static final long serialVersionUID = -2250201287022325868L;

	@EmbeddedId
	private PKLieux pk = new PKLieux();
	...
	public PKLieux getPk() {
		return pk;
	}

	public void setPk(PKLieux pk) {
		this.pk = pk;
	}
