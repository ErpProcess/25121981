...
<ext:body     >
    ...
    <form  id="myform" method="post"  name="myform"  autocomplete="off"  >
      ...
      <table style="background: url('${pathRootac}/img/blue.jpg');width: 100%;" border="0"  >
        ...
        <tr>
         ...
         <img src="${pathRootac}/img/logo44E.png"  align="middle" style="position: relative;background: none;left: -50px;top: 20px;display: none;" />
        
                  
				         </div>
          </td>
          <td   width="70%"  ><div class="login"  style="width: 270px;background: none;height: 110px;margin-top: -2%;"  >
              <table   style="margin-left: -3%;margin-top: 2%;display: none;">
                <tr>
                  ...
                  <td><input  autocomplete="off"    id="usr_login"  name="usr_login"   required      
                           onBlur="validAuthen()"   value=""   Type="text"  maxlength="4"    style="width: 70px;height: 22px;font-weight: bold;display: none;"   /></td>
                  <td></td>
                </tr>
                <tr>
                  <td   ><font style="font-weight: bold;font-size: 11px;">.::
                  ...
                  <td><input autocomplete="off"  id="nomprenom"  name="nomprenom"  type="text"   readonly="readonly" 
                     value=""  style="width: 150px;height: 22px;background: none;font-weight: bold;display: none;"   >
        ...
        <tr>
          <td  valign="top"><div class="login"  style="width: 160px;background: none;height: 5px;display: none;"  >
          ...
          <td  align="center"      ><div class="login"  style="width:270px;background: none;height: 5px;"  >
              <button class="blue"   id="btnSave"  onclick="doWelcome()"   type="submit"  style="position: relative ;top: -200%;display: none;"  ><font style="font-size: 12px;">Connexion</font></button>
            </div></td>
        </tr>
        <tr>
          <td  valign="middle"  colspan="2"  align="center"  height="25px" ><font  style="font-weight: bold;color: gray;font-family: cursive;font-size: 10px;display: none;">
  ...
  <div id="cand1"   style="position: fixed;width: 100%;height: 10000px;">
    <div id="cand"   style="position: fixed;top: 75%;text-align: center;width: 99%;"></div>
  </div>
</ext:body>
<script>
