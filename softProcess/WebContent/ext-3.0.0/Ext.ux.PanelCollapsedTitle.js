...
Ext.ux.PanelCollapsedTitle = (function() {
  ...
  var patchCollapsedElem = function() {
    ...
    if (verticalText && supportsSVG) {
      ...
      textContainer.setAttribute('x', 250);
    ...
    // For horizontal text or IE
      ...
      if (verticalText) {
        ...
        titleElemStyle += 
          'white-space: nowrap; writing-mode: tb-rl;margin-top:100px;top:50px; left: 3px;';
      } else {
        titleElemStyle += 'top: 200px;';
          ...
          // otherwise create the img for the icon
            ...
            Ext.DomHelper.insertBefore(hd.dom.firstChild, {
              ...
              style: verticalText 
                ...
                : 'margin-top: 40px; margin-right: 4px'
            });
          };
        };
      };
