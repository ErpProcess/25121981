...
$("#tblDataB").find("select:not([libre])").attr("disabled",tml_disabled=="true" ?true :false);
$("#tblDataB").find("input[idonly]").attr("readonly",tml_idReadonly=="true" ?true :false);	 
$("#tblDataB").find("input:not([libre]),button:not([libre]),textarea:not([libre])").attr("readonly",tml_readonly=="true" ?true :false);
$("#tblDataA").find("select:not([libre])").attr("disabled",tml_disabled=="true" ?true :false);
$("#tblDataA").find("input[idonly]").attr("readonly",tml_idReadonly=="true" ?true :false);	 
$("#tblDataA").find("input:not([libre]),button:not([libre]),textarea:not([libre])").attr("readonly",tml_readonly=="true" ?true :false);
...
config_header_foot_tableJQuey  ,  contenu_toolbarJQuey  );
  ...
  <ext:body  >
    ...
    <table  width="100%"><tr><td  width="50%">
		 <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  id="tblDataA"    width="100%"     >  
		   <tr>  
		 ...
		 <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  width="100%"   id="tblDataB"   >  
		   <tr>  
		  ...
		  <tr>  
		   ...
		   <td   > 
		    ...
		    <label>Ordre</label><input     id="serie_ordre"         name="serie_ordre"  size="4"   type="text"             value="${detailBean.serie_ordre}"   /> 
		  </td>  
		  </tr> 
