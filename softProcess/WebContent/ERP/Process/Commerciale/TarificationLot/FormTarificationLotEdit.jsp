...
if(Xcode2X=="pk.num_serie"){
   ...
   $("#datetarif_achat").val(json["datetarif_achat"]);
...
Ext.get('suiteTArif').setStyle('display', 'block');
  ...
  <table class="tableStyleContent"  cellpadding="5" cellspacing="10"   border="0"   > 
   ...
   <input id="pk.code_barre" name="pk.vente.fkCode_barre.pk.code_barre"     type="text"    size="30"       maxlength="100"        value="${detailBean.pk.vente.fkCode_barre.pk.code_barre}"    nextElement="ar_id"        required      />
   </td>
   <td>
 ...
 <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  id="tblData"  border="0"   > 
   ...
   <tr>  
    ...
    <td width="93%"  >  
    <input id="pk.num_serie"   name="pk.lot.pk.num_serie"         type="text"    size="20"       maxlength="50"   value=""         autofocus         />
    <input id="detaille_serie" name="detaille_serie"       type="text"    size="50"       maxlength="50"          value=""           />  
  </td>  
   </tr> 
   <tr>  
   <td  ><label>coût Primitive</label></td>  
   <td   >  
    <input id="codetarif" name="codetarif"    type="hidden"    size="10"              libre  readonly="readonly"  /> 
    <input id="datetarif_achat" name="datetarif_achat"    type="text"                libre  readonly="readonly"  />
    <input id="tarif_unit_achat" name="tarif_unit_achat"    type="montant3"              libre  readonly="readonly"    /> 
  </td>
   ...
   <td width="93%"  >  
   <input id="depot_id"   name="pk.lot.pk.depot.depot_id"         		type="text"    size="20"       maxlength="50"        value=""    autofocus   />
   <input id="depot_libelle" name="pk.lot.pk.depot.depot_libelle"       type="text"    size="50"       maxlength="50"        value=""           />  
  </td>  
   </tr>   
    <tr>  
