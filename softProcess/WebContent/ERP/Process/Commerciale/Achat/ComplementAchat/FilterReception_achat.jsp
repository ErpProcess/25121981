 ...
 <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  id="tblData"     >  
  ...
  <tr>  
   ...
   <td    >  
	   ...
	   <tr>
	     <td width="40%" > 
	     <fmt:formatDate pattern="dd/MM/yyyy"  value="${searchBean.achat.pk.achat_date}"   var="searchat_date"/>
	     <input id="achat_date"             compareTo="achat_date2"      name="achat.pk.achat_date"        type="datepicker"    size="13"       maxlength="13"        value="${searchat_date}"    nextElement="achat_date2"              /></td>
   ...
   <input id="depot_libelle" name="achat.pk.depot_stocks.depot_libelle"     type="text"    size="30"       maxlength="10"        value="${searchBean.achat.pk.depot.depot_libelle}"    nextElement="btValidx"         />  
  </td>  
   </tr>   
 </table>   
</ext:panel>
