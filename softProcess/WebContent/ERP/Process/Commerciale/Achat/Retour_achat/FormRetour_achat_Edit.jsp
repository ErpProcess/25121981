...
var     retournX = doGenerate_methode_ajaxWithReturn('POST',urls_Generic_def+"?nameList=list_editable_retour_achat",'i$_ACT_VERIF_LIST','text',false);
...
$(document).ready(function () {
 ...
 mapEditableGen = {            "otab"   :oTable,
                               ...
                               "mapCol" :[ 
										   ...
										   {      "sWidth": "10%"  , "sName": "pk.det_re.quantite"    },
										          
										   {      "sWidth": "10%"  , "sName": "quantite_retourne"    , "mRender": function( data, type, full){
									              return  '<input  type="number"     id=quantite_retourne'+full[2]+'  name=quantite_retourne    value="'+data+'"    style="width:75px;"     onblur=doEnvoiDataV2(this,"'+full[2]+'")    >';} },      
