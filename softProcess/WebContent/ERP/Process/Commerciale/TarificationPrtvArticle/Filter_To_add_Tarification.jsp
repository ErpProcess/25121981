  ...
  <ext:panel  border="false"    bodyStyle="background: none;"      renderTo="ThePageJsp"      style="margin:5px 5px 5px 5px;"   >  
		   ...
		   <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  id="tblData"  border="0"   > 
			   ...
			   <tr>  
			    ...
			    <td width="83%" >
				   <table>
				    <tr>
				     <td ><input id="pk_article.ar_id" name="pk.fkCode_barre.pk.ar_bean.pk_article.ar_id"     type="text"    size="10"       maxlength="25"        value="${detailBean.pk.fkCode_barre.pk.ar_bean.pk_article.ar_id}"    nextElement="pk.code_barre"             /></td> 
				     <td><input  id="ar_libelle"       name="pk.fkCode_barre.pk.ar_bean.ar_libelle"           type="text"    size="25"       maxlength="25"        value="${detailBean.pk.fkCode_barre.pk.ar_bean.ar_libelle}"    nextElement="pk.code_barre"               /></td>   
				    </tr>    
				  </table>  
			   </td> 
	          </tr>
	          ...
	          <tr> 
			    ...
			    <td     >  
			    <table><tr> <td>
			    <input id="pk.code_barre" name="pk.fkCode_barre.pk.code_barre"     type="text"    size="10"       maxlength="100"        value="${detailBean.pk.fkCode_barre.pk.code_barre}"    nextElement="TosuivTarif"            required  />
			    </td>
			    <td>
			    <input id="designation_libelle" name="pk.fkCode_barre.designation_libelle"     type="text"    size="45"       maxlength="100"        value="${detailBean.pk.fkCode_barre.designation_libelle}"    nextElement="TosuivTarif"          required    />
			    </td> </tr> </table>  
			   </td>  
	          </tr>   
		   </table>  
		 ...
		 <ext:panel  title="Historique Tarification"     bodyStyle="background: none;"  border="true"  height="185"   style="margin:-189px 5px 5px 49%;width:48%;padding-right:5%;"  > 
	       <script type="text/javascript">
               mapEditableGen= {"otab"   :oTable,
                               ...
                               "mapCol" :[ 
                                        {"sName": "pk.typ_trfBean.type_trf_lib"      ,"sWidth": "10%"   , "bSortable": "true"   },
									    {"sName": "pk.date_trf"      ,"sWidth": "10%"   , "bSortable": "true"   },  
									    {"sName": "pk.prix_unit_achat"  ,"sWidth": "30%"   , "bSortable": "true"   },  
									    {"sName": "coef_trf"         ,"sWidth": "10%"   , "bSortable": "true"   },  
									    {"sName": "pk.prix_unit_vente"  ,"sWidth": "30%"   , "bSortable": "true"   },  
									    {"sName": "taux_remise"      ,"sWidth": "10%"   , "bSortable": "true"   },  
									    {"sName": "pk.tvaBean.tva_id"  ,"sWidth": "10%"   , "bSortable": "true"   },
									    ]
                               };
			 </script> 
		...
		<ext:panel title="Editer Tarification Achat"   style="margin:5px 5px 5px 5px;width:46%;"   height="185"  bodyStyle="background: none;" border="true"  >
			<table class="tableStyleContent"  cellpadding="5" cellspacing="10"  border="0"  >
			 <tr>
			   ...
			   <td  width="70%" >
			    <fmt:formatDate pattern="dd/MM/yyyy"  value="${detailBean.pk.date_trf}"   var="WW"/>
	            <input id="date_trf" name="pk.date_trf"   type="datepicker"    size="13"       maxlength="13"       value="${WW} "    nextElement="code_barre"       required     />
			   </td>
			</tr>
			<tr>
				<td ><label>${tva_id}</label></td>  
				 <td > 
					   <script type="text/javascript">
						    $(document).ready(function() {
						     loadSelectAjax("tva_id","list_tvList","tva_id","tva_libelle","${detailBean.pk.tvaBean.tva_id}",true);
						    });
					    </script> 
				   <select   id="tva_id" name="pk.tvaBean.tva_id"           libre      nextElement="coef_trf"           ></select> 
			 ...
			 <tr>  
					   ...
					   <td >  
					   <input id="prix_unit_achat" name="pk.prix_unit_achat"   class="money2"   type="montant"    size="17"     
					     maxlength="17"        value="${detailBean.pk.prix_unit_achat}"    nextElement="type_trf_id"    
	   ...
	   <ext:panel  title="Editer Tarification Vente Par Cathégorie" border="true"  bodyStyle="background: none;"  height="185"  style="margin:-189px 5px 5px 49%;width:48%;"  >
               ...
               mapEditableGen_Vente= {"otab"   :oTableVente,
                               "table"  :"grid_Vente",
                               "list"   :"listmaxTarific",
                               "id_name":"pk.typ_trfBean.type_trf_id",
                               "url"    :"${urlloadDataTableAjax}",
                               "action" :"i$_ACT_LOAD_EDITABLE_TABLE_AJAX",
                               "mapCol" :[ 
                                        ...
                                        { "sTitle": "sw" , "sName": "pk.typ_trfBean.type_trf_id"       ,"sWidth": "10%"   , "bSortable": "true" ,"bVisible": false   }, 
                                        
                                        { "sTitle": "Type" , "sName": "pk.typ_trfBean.type_trf_lib"       ,"sWidth": "10%"   , "bSortable": "true"   }, 
									    ...
									    { "sTitle": "${coef_trf}" , "sName": "coef_trf"         ,"sWidth": "10%"   , "bSortable": "true"  ,"mRender": function( data, type, full){  var DTy=formatNumberJs(data,3); 
	                                     ...
	                                     { "sTitle": "${marge_vente}" , "sName": "marge_vente"         ,"sWidth": "10%"   , "bSortable": "true"  ,"mRender": function( data, type, full){  var DTy=formatNumberJs(data,3); 
	                                           return '<input   type="text"  size="7"          id=marge_vente'+full[2]+'      name=marge_vente    '+nature_marge+'      value="'+DTy+'"     onblur=doEnvoiDataV3(this,"'+full[2]+'")   nextElement=prix_unit_vente'+full[2]+'  >'; }},       
	                                              
									    { "sTitle": "${prix_unit_vente}" , "sName": "pk.prix_unit_vente"  ,"sWidth": "30%"   , "bSortable": "true"  ,"mRender": function( data, type, full){  var DTy=formatNumberJs(data,3); 
	                                        return '<input   type="text"  size="7"           id=prix_unit_vente'+full[2]+'   '+nature_prix_vente+'    name=pk.prix_unit_vente      value="'+DTy+'"     onblur=doEnvoiDataV3(this,"'+full[2]+'")   nextElement=taux_remise'+full[2]+'  >'; }},
