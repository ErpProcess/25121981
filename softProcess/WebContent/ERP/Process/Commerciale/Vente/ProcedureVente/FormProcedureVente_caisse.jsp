...
contenu_toolbarJQuey          ='<b><input  id="b1"  type="button"  value="+"    onclick="ADD()"   style="font-size: 16px;width: 40px;text-align:center;" > <input  type="button"  value="-"       onclick="Delete_ROW()"                  style="font-size: 16px;width: 40px;"  ></b>';
...
var mapEditableGen = {            
        ...
        "mapCol" :[ 
					   ...
					   {      "sTitle":"Prix U"    , "sName": "tarif.tarif_unit_vente"   ,"sWidth": "5%"    ,"sClass" : "alignRight"       , "bSortable": true 
 ...
 <table class="tableStyleContent" cellpadding="2" cellspacing="2" id="tblData" width="100%" border="0">
             ...
             <table id="GRID_SAISIE_DETAIL_VENTE" class="display"    > 
			      ...
			      <thead   >
					...
					<tr style="border-color:#a9bfd3;background-color:#d0def0;"   >
					    ...
					    <th   ></th>
						<th><input   type="hidden"       id="pk.code_barre"         name="code_barreX"                >
    ...
    <tr>
        ...
        <td  >
            ...
            <input id="vente_remise" name="vente_remise" type="montant3" size="17" libre readonly="readonly" value="${detailBean.vente_remise}" />
        </td>
    </tr>
    ...
    <tr>   
        ...
        <td><input id="vente_mnt_net_a_payer" name="vente_mnt_net_a_payer" type="montant3" size="17" libre readonly="readonly" maxlength="15" value="${detailBean.vente_mnt_net_a_payer}" /></td>
    </tr>
    
    

    <tr>
        <td><button value="Espace" >Espace</button></td>
        <td>
   ...
   <tr>
        ...
        <td><label> Net.A Payer</label></td>
        <td><input id="vente_mnt_net_a_payer" name="vente_mnt_net_a_payer" type="montant3" size="17" libre readonly="readonly" maxlength="15" value="" /></td>
    </tr>
