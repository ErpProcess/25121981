...
var sss_mapEditableGen = {     "otab"   :oTableBb,
                               ...
                               "mapCol" :[ 
									       ...
									       {    "sTitle":"X" ,   "sName": "to_check"     ,"sWidth": "2%"   ,"bSortable": true    ,"bVisible": true , "mRender": function( data, type, full){
									              return  '<input  type="checkbox" value="'+data+'"   id=to_check'+full[5]+' name=to_check    '+data+'   onclick=doEnvoiDataV3(this,"'+full[5]+'")        >';}}, 
										   ...
										   {   "sTitle":"Qte choisie" ,   "sName": "quantite_choisi"                 , "sWidth": "10%"     ,"mRender": function( data, type, full){  
										          return '<input   type="number"      style="width:70px;"     id=quantite_choisi'+full[5]+'       name=quantite_choisi        value="'+data+'"       onblur=doEnvoiDataV3(this,"'+full[5]+'")         >'; }},
