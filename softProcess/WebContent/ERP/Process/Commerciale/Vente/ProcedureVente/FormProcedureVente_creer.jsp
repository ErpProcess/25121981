...
if(custumMessageBoxo!=""  &&  custumMessageBoxo =="successfullyConfirmation"){
	...
	Ext.MessageBox.show({
        ...
        msg: 'Confirmation effectuée avec succès',
...
if(custumMessageBoxo!="" &&  custumMessageBoxo=="successfulInvoicing"){
	Ext.MessageBox.show({
        ...
        msg: 'Facturation effectuée avec succès',
     ...
     if("${bs.fct_id}"=="27") {
    	 ...
    	 var  verifNumFac =doGenerate_methode_ajaxWithReturn('POST','${tmlx.urlAjax}','i$_ACT_VERIF_LIST_FACT','text',false);
		  ...
		  if(verifNumFac!="" &&  verifNumFac.startsWith("|") )  {
			  ...
			  Ext.MessageBox.show({
		      title:'INFO',
		      msg: ' Voulez vous Choisir un Numéro Déja Supprimée : '+maselectFact,
...
var mapEditableGen2 = {        "otab"   :oTable23,
                               ...
                               "mapCol" :[ 
	                                       ...
	                                       {    "sTitle":"Mvt" , "sName": "isVente"    ,"sWidth": "20%"     ,"sClass" : "alignRight"     , "bSortable": true ,"bVisible": true  
	                                           ,"mRender": function (data, type, full) {return   data=="false"?"D�pense":"Vente"   }    }, 
...
//Ext.getCmp('RET_GRID').setTitle(' D�taille Vente ');
	          ...
	          <table id="GRID_SAISIE_PRESATATION" class="display" width="100%"    >
			      <thead   >
			       <tr style="border-color:#a9bfd3;background-color:#d0def0;"   >
						...
						<th><select   id="isVentePrestation"  name="isVentePrestation"   > <option  value="true"  > Vente </option><option value="false">D�pense </option>  </select> </th>
						<th></th>
						<th></th>
						<th></th>
						<th></th>
	         ...
	         <table id="GRID_SAISIE_FOURNITURE_VENTE" class="display" width="100%"   >
			      <thead   >
			        <tr style="border-color:#a9bfd3;background-color:#d0def0;"   >
						...
						<th><select   id="isVente"  name="isVente"   ><option  value="true"  > Vente </option> <option value="false">D�pense </option>  </select>   </th>
						<th></th>
						<th></th>
						<th></th>
					</tr>
