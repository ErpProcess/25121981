...
var lumsbean=[ 
	    ...
	    {    "sTitle":"Piece"     ,"sName": "modeBean.fct_libelle"                   ,"bSortable": true    },
...
<ext:body  >
  <ext:panel  border="false"    bodyStyle="background: none;"      renderTo="ThePageJsp"   >
   ...
   <ext:panel  border="false"    bodyStyle="background: none;"       >
        ...
        <ext:toolbar.button  text=" Suivant  >> "   style="margin-left:999px;"   onClick="getSuiv()"    disabled="true"   id="btnnext"  ></ext:toolbar.button> </ext:toolbar>
    ...
    <table width="100%"  cellpadding="5" cellspacing="10" class="tableStyleContent"  id="tblData"     >
      ...
      <tr>
        ...
        <select  id="reg_mod"  name="mode.data_id"           style="width: 180px;"      nextelement="reg_nbr_echeance"        required="required"   >
        </select></td>
        <td  >${num_piece}</td>
      ...
      <tr>
        ...
        <script  >$(function() {  loadSelectAjax("reg_nature","list_nature_reglement","data_id","data_libelle","${detailBean.nature.data_id}",false);  })</script>
         <select id="reg_nature" name="nature.data_id"              nextelement="reg_nbr_echeance" > </select> </td>
      ...
      <tr>
        ...
        <td   ><label> </label></td>
        <td   ><input id="montant_avance" name="montant_avance"       type="hidden"    size="17"              ></td>
        <td   ><label>  Net à rembourser</label></td>
        <td   ><input id="montant_restant" name="montant_restant"     type="montant3"    size="17"       maxlength="17"        value="${detailBean.montant_restant}"    nextelement="num_piece"></td>
      </tr>
    </table>
      </ext:panel>
      <c:if test="${ detailBean.reg_nbr_echeance > 0 }">
