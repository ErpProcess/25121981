 ...
 mapEditableGen = {            "otab"   :oTable,
                               "table"  :"GRID_PRODUIT_CLIENT",
                               "list"   :"list_produit_client",
                               "id_name":"pk.client.clt_id",
                               ...
                               "mapCol" :[ 
										  ...
										  { "sTitle": "code"                   ,"sName": "pk.client.clt_id"                         ,"sWidth": "5%"   , "bSortable": "true"   }, 
										  { "sTitle": "libelle"                ,"sName": "pk.client.clt_lib"                       ,"sWidth": "10%"   , "bSortable": "true"   },
	                                            ]
...
if(!teste_required()) return ;
 ...
 var json=doGenerate_methode_ajaxWithReturn('POST','${tmlx.urlAjax}','i$_ACT_GET_ARTICLE_CLIENT','json',false);
...
Ext.get('GRID_CLT_CHOIX').setStyle('display', 'block');
...
<ext:panel    title="Liste des client"  id="GRID_CLT_CHOIX"   border="false"   bodyStyle="background: none;"     style="display:none;"   >
  <table id="GRID_PRODUIT_CLIENT" class="display" width="100%"     ></table>
 </ext:panel>
</ext:panel>
</ext:body>
