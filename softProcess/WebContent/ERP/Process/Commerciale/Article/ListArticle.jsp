...
//   { "sTitle": "code"               ,"sName": "pk_article.ar_id"           ,"sWidth": "10%"   , "bSortable": "true"   }, 
  { "sTitle": "Famille"            ,"sName": "fam_art.fam_lib"            ,"sWidth": "30%"   , "bSortable": "true"   }, 
  ...
  { "sTitle": "${sitcod}"          ,"sName": "bean_sitcod.data_libelle"   ,"sWidth": "20%"   , "bSortable": "true"    },    
...
<table 		 id="${nameGrid}"     class="display"  ></table>
