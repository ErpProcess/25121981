...
var  nameListAjax   ="&nameList=listGridEditable_smfction";
...
function doEnvoiData(element){
    ...
    var hashmap ={"sNameId":"pk.fcBean.fct_id", "sValueId": idToSendo,"sDataValue":LEvalue,"sNameColumn" :name_column,"sNameList":"listGridEditable_smfction"};
	jQuery.ajax({ 
	     type: 'POST',  
	     url: urlsUpdateURL, 
	     data:hashmap,
...
var sNameBean=[
			   ...
			   {  "sTitle": "Ordre"  ,"sName": "ordre"              ,"sWidth": "30%"   ,"mRender": function( data, type, full){  
	               return '<input idRow='+full[2]+' type=\'number\'  id=ordre'+full[0]+'   name=ordre        value='+data+'    onblur=doEnvoiData(this)   nextElement=view_smfct_action'+full[5]+'   />';}},
	               
	           {  "sTitle": "view_smfct_action"  ,"sName": "view_smfct_action"   ,"sWidth": "30%"   ,"mRender": function( data, type, full){  
	               return '<input idRow='+full[2]+' type="text"   id=view_smfct_action'+full[0]+'   name=view_smfct_action        value="'+data+'"    onblur=doEnvoiData(this)   nextElement=ordre'+full[5]+'   />';}},
		 ...
		 <table class="tableStyleContent"  cellpadding="5" cellspacing="10"  id="tblData"     >  
          ...
          <div id="container">
			  <div  id="topy" class="x-panel-header"  style="height: 15px;width: 100%;"   >
			     <div  style="margin-top: -4px;">Affectation fonction- sous module</div> 
			  </div>
		      <div id="demo_jui"> <table id="gridColon" class="display" width="100%" ></table></div>
	      </div>  
</ext:panel>
</ext:body>
