...
<ext:body>
      <ext:panel  renderTo="ThePageJsp" border="false"     autoScroll="true"  cmargins="0"  >
      
      <div       style="margin: 0px 0px 0px 0px;position: static;" >
	           <div  class="x-panel-header" style="height: 16px;" >
	            <font color="black"  style="font-size: 11px;"> ${bs.pack_libelle} </font> 
